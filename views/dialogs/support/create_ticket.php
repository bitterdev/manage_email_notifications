...
use Concrete\Package\ManageEmailNotifications\Controller\Dialog\Support\CreateTicket;
...
<form action="<?php echo (string)Url::to("/ccm/system/dialogs/manage_email_notifications/create_ticket/submit"); ?>"
      data-dialog-form="create-ticket"
      method="post"
      enctype="multipart/form-data">

    <?php echo $form->hidden('projectHandle', "manage_email_notifications"); ?>
